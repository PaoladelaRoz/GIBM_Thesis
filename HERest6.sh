...
do
 ...
 do
  ...
  input1="${macros_subdir}/6GMM_1/${i}stG${g}hmmdefs.txt"
  input2="${hmmdefs_subdir}/6GMM_1/macros${i}st_${g}"
  output_subdir="${output_dir}/G${g}/6GMM_2"
  ...
  input1="${macros_subdir}/6GMM_2/${i}stG${g}hmmdefs.txt"
  input2="${hmmdefs_subdir}/6GMM_2/macros${i}st_${g}"
  output_subdir="${output_dir}/G${g}/6GMM_3"
