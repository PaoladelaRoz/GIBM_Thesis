#!/bin/bash
#3 gaussians in total, 2 gaussian added
...
do
 ...
 do
  ...
  input1="${macros_subdir}/2GMM_3/${i}stG${g}hmmdefs"
  input2="${hmmdefs_subdir}/2GMM_3/macros${i}st_${g}"
  output_subdir="${output_dir}/G${g}/3GMM_1"
