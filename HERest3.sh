...
do
 ...
 do
  ...
  input1="${macros_subdir}/3GMM_1/${i}stG${g}hmmdefs.txt"
  input2="${hmmdefs_subdir}/3GMM_1/macros${i}st_${g}"
  output_subdir="${output_dir}/G${g}/3GMM_2"
  ...
  input1="${macros_subdir}/3GMM_2/${i}stG${g}hmmdefs.txt"
  input2="${hmmdefs_subdir}/3GMM_2/macros${i}st_${g}"
  output_subdir="${output_dir}/G${g}/3GMM_3"
